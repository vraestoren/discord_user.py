...
class DiscordUser:
	...
	def get_guilds(self) -> dict:
		return self.session.get(f"{self.api}/users/@me/guilds").json()

	def get_guild_info(self, guild_id: int) -> dict:
		return self.session.get(f"{self.api}/guilds/{guild_id}").json()
	...
	def get_account_channels(self) -> dict:
		return self.session.get(f"{self.api}/users/@me/channels").json()
	...
	def get_relationships(self) -> dict:
		return self.session.get(f"{self.api}/users/@me/relationships").json()

	def get_user_info(self, user_id: int) -> dict:
		return self.session.get(f"{self.api}/users/{user_id}/profile").json()
	...
	def change_username(
		...
		return self.session.patch(f"{self.api}/users/@me", json=data).json()
	...
	def send_message(
		...
		return self.session.post(
			f"{self.api}/channels/{channel_id}/messages", json=data).json()
	...
	def get_voice_regions(self) -> str:
		return self.session.get(f"{self.api}/voice/regions").text

	def get_guild_bans(self, guild_id: int) -> dict:
		return self.session.get(f"{self.api}/guilds/{guild_id}/bans").json()

	def get_guild_users(self, guild_id: int) -> dict:
		return self.session.get(f"{self.api}/guilds/{guild_id}/members").json()
	...
	def edit_message(
		...
		return self.session.patch(
			f"{self.api}/channels/{channel_id}/messages/{message_id}", json=data).json()
	...
	def create_role(
		...
		return self.session.post(
			f"{self.api}/guilds/{guild_id}/roles", json=data).json()
